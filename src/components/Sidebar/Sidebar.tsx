...
const Sidebar = ({children}:{children: React.ReactNode}) => {
  ...
  <div className="fixed top-0 mt-16 p-3">
      <nav className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(100vh-2rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">  
...
<div className='max-w-xl justify-center sm:px-6 flex items-center -mt-12'>
  {children}
</div>
    </div>
  )
